    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        ...
        <a class="navbar-brand brand-logo-mini" href="index.html">
            <img src="../Recursos/images/logo-mini.svg" alt="logo" />
        </a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <img class="img-xs rounded-circle" src="../Recursos/images/faces/face1.jpg" alt="Profile image">
            </a>
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                    <img src="../Recursos/images/faces/face1.jpg" alt="profile image">
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="fluid-container">
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                          <img class="img-sm rounded-circle mb-4 mb-md-0" src="../Recursos/images/faces/face2.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
